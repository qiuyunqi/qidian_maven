	...
	<div class="container bodyHget">
		...
		<div class="communit-nav">
			<ul>
				...
				<li class="communit-active"><a href="javascript:void(0)" title="收入记录">收入记录</a></li>
		...
		<table class="table table-striped table-bordered table-hover setTab" cellpadding="0" cellspacing="0" width="100%" border="0">
			<tr>
				...
				<th>序号</th>
				<th class="blueCol">交易时间</th>
				<th class="blueCol">收入详情</th>
				<th>总收入</th>
			</tr>
			...
			<tr>
				...
				<td>${moneyDetail.accountBalance}</td>
			</tr>
			</c:forEach>
		</table>
		<!-- 分页 -->
