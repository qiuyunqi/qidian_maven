  ...
  <!-- 页头 -->
	...
	<div class="container bodyHget">
		...
		<div class="sidebar-left flatLft">
			...
			<a class="message-send" href="${ctx}/web/qida/message/choose.html" title="给关注的人发消息">给关注的人发消息</a>
		</div>
		<!-- 右边 -->
		<div class="sidebar-right">
			...
			<!-- 一条数据 -->
			<c:forEach items="${unReadList}" var="message">
				<li>
	...
	$("#delMsg").click(function() {
		var $str = "";
		$("[name='msgFlag'][checked]").each(function(){ 
			$str+=$(this).val()+","; 
		});
		$.ajax({
			type: 'POST',
			...
			success: function(data){
				...
				if (data.success == 0) {
					...
					globalTip(data.message);
					location.href="${ctx}/web/unRead.html";
				}
			},
			beforeSend:function() {
