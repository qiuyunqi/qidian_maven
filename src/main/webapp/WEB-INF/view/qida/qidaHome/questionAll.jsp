							...
							<div class="lfContainer">
								<div class="infoBody">
									...
									<div class="zhidao-question">
											...
											<a class="money" href="javascript:void(0)" title="付费"><i class="${question.replyNum==0?'mony':'moneyAcv'}"></i>${hot.reward}</a>
									</div>
									<!-- 回答/浏览/时间 -->
									<div class="zhidao-question-unit-count2">
										<ul>
											...
											<li class="zjinff">
												<c:if test="${not empty hot.answerUser && question.replyNum==0 && ((nowDate.time-hot.updateTime.time)/1000/60/60)>2}"><span class="zjinff-zjInfo">超时未回答，可以抢答</span></c:if>
												<c:if test="${not empty hot.answerUser && ((nowDate.time-hot.updateTime.time)/1000/60/60)<=2}"><span class="zjinff-zjInfo">已邀请${hot.answerUser.nickName==null?'佚名':hot.answerUser.nickName}</span></c:if>
											</li>
										</ul>
									</div>
									<!-- 回答 -->
									...
									<div class="question-stock">
										<ul>
											<li><a href="javascript:void(0)" target="_blank">sh600810</a></li>
											<li><a href="javascript:void(0)" target="_blank">sh600810</a></li>
											<li><a href="javascript:void(0)" target="_blank">sh600810</a></li>
										</ul>
									</div>
