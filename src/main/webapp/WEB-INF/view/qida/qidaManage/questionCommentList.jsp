...
<body style="background:#fff">
	...
	<table id="dg" title="问题评论列表" class="easyui-datagrid" width="100%" style="height:auto"
            url="${ctx}/web/admin/questionCommentData" 
        ...
        <thead>
            <tr>
                ...
                <th field="nickName" width="30">用户昵称</th>
