			...
			<c:if test="${ !empty goodCommentList || !empty middleCommentList || !empty badCommentList}">
				...
				<div class="allBody">
					<ul class="discussList textCen" id="navNor">
						...
						<li class="discussLi textCen disListAct"><div id="cry" class="discussLs"><span class="plBody"><i class="cryAct"></i>中评</span><br/>${middleCount}</div></li>
					...
					<ul class="discussListA textCen"  id="navFixed" style="display:none;">
						<li class="disLiss discussLi textCen borRgt"><div id="smilA" onclick="kLine('${id}')"><span class="plBody"><i class="smil"></i>好评</span><br/>${goodCount}</div></li>
						<li class="discussLi textCen borRgt disListAct"><div id="cryA"><span class="plBody"><i class="cryAct"></i>中评</span><br/>${middleCount}</div></li>
						<li class="discussLi textCen borRgt disLiss" onclick="kLineBad('${id}')"><div id="bigCryA"><span class="plBody"><i class="bigCry"></i>差评</span><br/>${badCount}</div></li>
					</ul>
					<div class="hrline clear" ></div>
					<div class="disContent">
						<!-- 中评 -->
						<div class="disBody" id="midBody">
							<c:if test="${empty middleCommentList}">
						  	    <div class="noBody" id="midBod">
									<a><img src="${ctx}/web/images_line/ganta.png"/></a>
...
$(".gLisInfo").each(function(){
   ...
   //跳到详情页
    ...
    function kLineBad(id) {
   		  window.location = "${ctx}/web/stock/kLine?id="+id+"&type=2";  
    }
